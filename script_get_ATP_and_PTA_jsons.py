...
if __name__ == '__main__':
    ...
    with open('data_learnsets.txt') as json_file:
    ...
    write_to_json('data_abilities_to_pokemon.json', abilities_to_pokemon_map)
    write_to_json('data_pokemon_to_abilities.json', pokemon_to_abilities_map)  